...
class BaseCommand extends Command
{
    ...
    public function getOptions()
    {
        return [
            ...
            ['only', null, InputOption::VALUE_REQUIRED, 'Generate ONLY Specific Items (migration,model,controllers,api_controller,scaffold_controller,repository,requests,api_requests,scaffold_requests,routes,api_routes,scaffold_routes,views,tests,menu,dump-autoload)'],
        ];
    }
